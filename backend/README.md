...
## Project Structure
    ...
    ├── workflow_logistics__41880  # Django project configurations
...
1. Clone this repo and `cd workflow_logistics__41880`
...
2. Clone this repo and `cd workflow_logistics__41880`
