"""
Django settings for workflow_logistics__41880 project.
...
ROOT_URLCONF = 'workflow_logistics__41880.urls'
...
WSGI_APPLICATION = 'workflow_logistics__41880.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "workflow_logistics__41880 API",
    "DESCRIPTION": "API documentation for workflow_logistics__41880 App",
    "VERSION": "v1",
}
